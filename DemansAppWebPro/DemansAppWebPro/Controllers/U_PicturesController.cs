...
namespace DemansAppWebPro.Controllers
{
    ...
    public class U_PicturesController : Controller
    {
        private readonly EntitiesContext db;

        public U_PicturesController(EntitiesContext _db)
        {
            db = _db;
        }
        ...
        [HttpGet]
        public JsonResult DeletePicture(int pr)
        {
            try
            {
                var _d_picture =  db.Pictures.Where(w => w.Id == pr).FirstOrDefault();
